// Generated by gencpp from file computer_pkg/AiDetection.msg
// DO NOT EDIT!


#ifndef COMPUTER_PKG_MESSAGE_AIDETECTION_H
#define COMPUTER_PKG_MESSAGE_AIDETECTION_H
...
struct AiDetection_
{
  ...
  typedef boost::shared_ptr< ::computer_pkg::AiDetection_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::computer_pkg::AiDetection_<ContainerAllocator> const> ConstPtr;

}; // struct AiDetection_

typedef ::computer_pkg::AiDetection_<std::allocator<void> > AiDetection;

typedef boost::shared_ptr< ::computer_pkg::AiDetection > AiDetectionPtr;
typedef boost::shared_ptr< ::computer_pkg::AiDetection const> AiDetectionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::computer_pkg::AiDetection_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::computer_pkg::AiDetection_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::computer_pkg::AiDetection_<ContainerAllocator1> & lhs, const ::computer_pkg::AiDetection_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::computer_pkg::AiDetection_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::computer_pkg::AiDetection_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::computer_pkg::AiDetection_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::computer_pkg::AiDetection_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::computer_pkg::AiDetection_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::computer_pkg::AiDetection_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::computer_pkg::AiDetection_<ContainerAllocator> >
{
  ...
  static const char* value(const ::computer_pkg::AiDetection_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x66b7593eed3e8ef9ULL;
  static const uint64_t static_value2 = 0x1f597c785c6a914fULL;
};

template<class ContainerAllocator>
struct DataType< ::computer_pkg::AiDetection_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::computer_pkg::AiDetection_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::computer_pkg::AiDetection_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::computer_pkg::AiDetection_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::computer_pkg::AiDetection_<ContainerAllocator>& v)
  {
...
#endif // COMPUTER_PKG_MESSAGE_AIDETECTION_H
