...
get_filename_component(_filename "/home/arl/NSSSIP2023/src/drone_pkg/srv/PlaceSensor.srv" NAME_WE)
add_custom_target(_drone_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone_pkg" "/home/arl/NSSSIP2023/src/drone_pkg/srv/PlaceSensor.srv" ""
)

get_filename_component(_filename "/home/arl/NSSSIP2023/src/drone_pkg/srv/DroneOp.srv" NAME_WE)
add_custom_target(_drone_pkg_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "drone_pkg" "/home/arl/NSSSIP2023/src/drone_pkg/srv/DroneOp.srv" ""
)
