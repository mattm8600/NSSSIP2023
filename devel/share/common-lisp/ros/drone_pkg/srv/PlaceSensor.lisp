...
(cl:defmethod cl:initialize-instance :after ((m <PlaceSensor-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlaceSensor-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_pkg-srv:<PlaceSensor-request> is deprecated: use drone_pkg-srv:PlaceSensor-request instead.")))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <PlaceSensor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_pkg-srv:latitude-val is deprecated.  Use drone_pkg-srv:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <PlaceSensor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_pkg-srv:longitude-val is deprecated.  Use drone_pkg-srv:longitude instead.")
  (longitude m))

(cl:ensure-generic-function 'battery-val :lambda-list '(m))
(cl:defmethod battery-val ((m <PlaceSensor-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_pkg-srv:battery-val is deprecated.  Use drone_pkg-srv:battery instead.")
  (battery m))
...
(cl:defmethod cl:initialize-instance :after ((m <PlaceSensor-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlaceSensor-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name drone_pkg-srv:<PlaceSensor-response> is deprecated: use drone_pkg-srv:PlaceSensor-response instead.")))

(cl:ensure-generic-function 'target_latitude-val :lambda-list '(m))
(cl:defmethod target_latitude-val ((m <PlaceSensor-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_pkg-srv:target_latitude-val is deprecated.  Use drone_pkg-srv:target_latitude instead.")
  (target_latitude m))

(cl:ensure-generic-function 'target_longitude-val :lambda-list '(m))
(cl:defmethod target_longitude-val ((m <PlaceSensor-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader drone_pkg-srv:target_longitude-val is deprecated.  Use drone_pkg-srv:target_longitude instead.")
  (target_longitude m))
