...
(cl:in-package computer_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <AiDetection>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'AiDetection)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name computer_msgs-msg:<AiDetection> is deprecated: use computer_msgs-msg:AiDetection instead.")))

(cl:ensure-generic-function 'timestamp_ns-val :lambda-list '(m))
(cl:defmethod timestamp_ns-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:timestamp_ns-val is deprecated.  Use computer_msgs-msg:timestamp_ns instead.")
  (timestamp_ns m))

(cl:ensure-generic-function 'class_id-val :lambda-list '(m))
(cl:defmethod class_id-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:class_id-val is deprecated.  Use computer_msgs-msg:class_id instead.")
  (class_id m))

(cl:ensure-generic-function 'frame_id-val :lambda-list '(m))
(cl:defmethod frame_id-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:frame_id-val is deprecated.  Use computer_msgs-msg:frame_id instead.")
  (frame_id m))

(cl:ensure-generic-function 'class_name-val :lambda-list '(m))
(cl:defmethod class_name-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:class_name-val is deprecated.  Use computer_msgs-msg:class_name instead.")
  (class_name m))

(cl:ensure-generic-function 'cam-val :lambda-list '(m))
(cl:defmethod cam-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:cam-val is deprecated.  Use computer_msgs-msg:cam instead.")
  (cam m))

(cl:ensure-generic-function 'class_confidence-val :lambda-list '(m))
(cl:defmethod class_confidence-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:class_confidence-val is deprecated.  Use computer_msgs-msg:class_confidence instead.")
  (class_confidence m))

(cl:ensure-generic-function 'detection_confidence-val :lambda-list '(m))
(cl:defmethod detection_confidence-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:detection_confidence-val is deprecated.  Use computer_msgs-msg:detection_confidence instead.")
  (detection_confidence m))

(cl:ensure-generic-function 'x_min-val :lambda-list '(m))
(cl:defmethod x_min-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:x_min-val is deprecated.  Use computer_msgs-msg:x_min instead.")
  (x_min m))

(cl:ensure-generic-function 'y_min-val :lambda-list '(m))
(cl:defmethod y_min-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:y_min-val is deprecated.  Use computer_msgs-msg:y_min instead.")
  (y_min m))

(cl:ensure-generic-function 'x_max-val :lambda-list '(m))
(cl:defmethod x_max-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:x_max-val is deprecated.  Use computer_msgs-msg:x_max instead.")
  (x_max m))

(cl:ensure-generic-function 'y_max-val :lambda-list '(m))
(cl:defmethod y_max-val ((m <AiDetection>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader computer_msgs-msg:y_max-val is deprecated.  Use computer_msgs-msg:y_max instead.")
  (y_max m))
